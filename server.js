...
app.post("/score", async (req, res) => {
  ...
  const solution = { T: result.T, expression: result.expression, charCount: getCharCount(result.expression), playURL: level, level: result.level };
...
app.listen(port, () => console.log(`Doing some black magic on port ${port}...`));